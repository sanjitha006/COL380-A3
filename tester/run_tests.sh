...
if [ "$1" == "--gen" ]; then
    echo "=========================================================="
    echo " Generating Testcases and Checker Scripts using $PY_CMD"
    echo "=========================================================="
...
configs = [
    ("01_warmup",        400,  0.20,  800),
    ("02_small_dense",   400,  0.40,  800),
    ("03_med_sparse",    800,  0.10, 1000),
    ("04_med_dense",     800,  0.20, 1000),
    ("05_ta_clone",     1200, 0.103, 1000),
    ("06_large_1",      1200,  0.12, 1000),
    ("07_large_2",      1200,  0.15, 1000),
    ("08_stress_1",     1200,  0.18, 1000),
    ("09_stress_2",     1200,  0.22, 1000)
]
...
for name, N, density, B in configs:
    ...
    print("Generating {} (N={}, Target Edges=~{})...".format(name, N, int((N*(N-1)/2.0)*density)))
    ...
    with open(filepath, "w") as f:
        ...
        for i in range(N):
            f.write("{} {}\n".format(random.randint(10, 100), random.randint(10, 100)))
        for u, v in edges:
            f.write("{} {}\n".format(u, v))
...
module purge
module load compiler/gcc/9.1.0         # <-- ADD THIS LINE
